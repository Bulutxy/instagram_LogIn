...
class Instagram:
    ...
    def getFollowers(self):
        ...
        time.sleep(2)
        followersLink=self.browser.find_element(By.XPATH,'//*[@id="mount_0_0_K4"]/div/div/div[2]/div/div/div[1]/div[2]/div[1]/section/main/div/header/section[3]/ul/li[2]/div/a')
        followersLink.click()
